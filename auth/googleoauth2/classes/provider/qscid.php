...
class provideroauth2qscid extends League\OAuth2\Client\Provider\Qscid {

    // THE VALUES YOU WANT TO CHANGE WHEN CREATING A NEW PROVIDER.
    public $sskstyle = 'qscid';
    public $name = 'qscid'; // It must be the same as the XXXXX in the class name provideroauth2XXXXX.
    public $readablename = 'qscid';
    //public $scopes = array('read');
