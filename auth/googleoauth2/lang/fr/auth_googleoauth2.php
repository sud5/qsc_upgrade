...
// added for OAuth2 QSCID
$string['auth_qscidclientid'] = '';
$string['auth_qscidclientsecret'] = '';
$string['auth_qscidclientid_key'] = 'QSCID App key';
$string['auth_qscidclientsecret_key'] = 'QSCID App secret';

$string['signinwithanaccountqscid'] = 'CONNEXION / ENREGISTREMENT';

$string['usernamealreadyexists'] = 'Username or Email address is already exists with other authentication';

$string['useralreadydeleted'] = 'This account has been deleted';
