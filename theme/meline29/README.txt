...
This document describes how to copy and customise the meline29 (bootstrapbase) theme so that
...
From your Moodle theme directory right click on meline29 and then copy and paste back
into your Moodle theme directory. You should now have a folder called Copy of meline29.
...
underscores. For the purpose of this tutorial we will call the theme 'meline29theme'.

On opening 'meline29theme' your you will find several files and sub-directories which have
files within them.
...
where the old theme name occurs, in this case meline29. So using the above list as
a guide, search through and change all the instances of the theme name
'meline29' to 'meline29theme'. This includes the filename of the lang/en/theme_meline29.php.
You need to change this to 'theme_meline29theme.php'.
...
and then click on (meline29theme) or whatever you renamed your theme to,
from the list of theme names that appear at this point in the side block.

Customisation using custom theme settings
-----------------------------------------

The settings page for the meline29 theme can be located by navigating to:

Administration > Site Administration > Appearance > Themes > meline29

Moodle documentation
--------------------

Further information can be found on Moodle Docs: http://docs.moodle.org/dev/meline29_theme
