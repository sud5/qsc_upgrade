...
$hasfeatureoneimage = (!empty($PAGE->theme->settings->featureoneimage));
...
if (!empty($PAGE->theme->settings->featureoneimage)) {
   $welcomecontentimage = $PAGE->theme->setting_file_url('featureoneimage', 'featureoneimage');
} else {
...
<html <?php echo $OUTPUT->htmlattributes(); ?>>
        ...
        <meta property="og:title" content="Updated title of page" />
        <meta property="og:description" content="Updated message from book page" />
        <meta property="og:image" content="https://dev.training.qsc.com/pluginfile.php/1/theme_meline29/blocktwoimage/-1/Play_Demo.png" />
        <meta property="og:updated_time" content="<?php echo time();?>" />
        <!--"/theme/meline29/style/frontpage.css"-->

        <link href="/theme/meline29/style/frontpage.css" type="text/css" rel="stylesheet">
    ...
    <div class="container-fluid">
        ...
        <div class="login-link-sectin">
            ...
            <div class="logincont">
                ...
                <a href="<?php echo $CFG->wwwroot; ?>/login/signup.php" class="newreg"><?php echo get_string('register', 'theme_meline29'); ?></a> <a href="<?php echo new moodle_url('/login/index.php', array('sesskey'=>sesskey())), get_string('login') ?> " > <?php echo get_string('login') ?></a>
              </ul>
                    </div>
            <?php } ?>
          </div>
...
<?php  if ($showhideblockone) { ?>
        <div class="blend-box-one new-box"> 
            <div class="iconblock">
                <img src="<?php echo $blockoneimage; ?>" alt="">
            </div>
            <div class="textblock">
...
<?php  if ($showhideblocktwo) { ?>
        <div class="blend-box-two new-box">
            <div class="iconblock">
                <img src="<?php echo $blocktwoimage; ?>" alt="">
            </div>
            <div class="textblock">
...
<?php  if ($showhideblockthree) { ?>           
        <div class="blend-box-three new-box"> 
            <div class="iconblock">
                <img src="<?php echo $blockthreeimage; ?>" alt="">
            </div>
            <div class="textblock">
...
<?php  if ($showhideblockfour) { ?> 
        <div class="blend-box-four new-box">
            <div class="iconblock">
                <img src="<?php echo $blockfourimage; ?>" alt="">
            </div>
            <div class="textblock">
...
<?php  if ($showhideblockfive) { ?> 
        <div class="blend-box-five new-box">
            <div class="iconblock">
                <img src="<?php echo $blockfiveimage; ?>" alt="">
            </div>
            <div class="textblock">
...
<?php  if ($showhideblocksix) { ?> 
        <div class="blend-box-six new-box"> 
            <div class="iconblock">
                <img src="<?php echo $blocksiximage; ?>" alt="">
            </div>
            <div class="textblock">
...
// print_r($courseArr);
 ...
 //$sql1 = "SELECT c.fullname, cm.visible, cm.added, cm.course, cm.instance, cm.module, b.id, b.name as lesson_title, LEFT(bc.content, 200) AS lesson_desc FROM {course_modules} as cm, {course} as c , {book} as b, {book_chapters} as bc WHERE c.id = cm.course AND b.id = bc.bookid AND cm.visible = 1 AND cm.modulse = 3 AND cm.instance=b.id AND bc.title LIKE '%Description%' order by cm.added desc";
  $sql1 = "SELECT b.id, b.name as lesson_title, bc.content AS lesson_desc, cm.instance, cm.added FROM {course_modules} as cm JOIN {book} as b on cm.instance = b.id JOIN {book_chapters} as bc on b.id = bc.bookid WHERE cm.visible = 1 AND cm.module = 3 AND bc.title LIKE '%Description%' order by cm.added DESC LIMIT 0,4";
        ...
        <div class="blend-box-<?=$cntArr[$cntNum]?> second-sec">
                  <div class="blockimg">
                    <a href="javascript:void(0);" title="Image-title">
                        <img src="/theme/image.php?theme=meline29&amp;component=theme&amp;image=latest_content_img_1" alt=""> 
                    </a>
                  </div>
          <div class="blocktext">
            <h2><?=format_string($keys->lesson_title)?></h2>
            <span>Added <?=date("m-d-y",$keys->added)?></span>
            <p><?=format_string($keys->lesson_desc)?></p>
          </div>
        </div>              
          ...
          <?php  if ($showhidewelcomeblock) { ?>
            ...
            <div class="container-fluid third-blend-area">
                <div class="third-blend-full-section">
                    <h2>Call to Action Description block</h2>
...
<footer id="page-footer"> 
          ...
          <div id="ftr-menu">
    <div class="container-fluid">
              <div class="fmenu"><a href="<?php echo $CFG->wwwroot;?>">Home</a> <a href="/login/signup.php">Register</a> <a href="#">Privacy</a> <a href="#">Contacts</a></div>
            </div>
  </div>
