...
class mod_facetoface_observer {
    ...
    public static function user_enrolment_deleted(\core\event\user_enrolment_deleted $event) {
        ...
        if ($USER->id == 2 || $USER->usertype == 'mainadmin' || $USER->usertype == 'graderasadmin') {
            //var_dump($SESSION->removeAttendee); //unset($SESSION->removeAttendee); exit("22"); 
            if(isset($SESSION->removeAttendee) && !empty($SESSION->removeAttendee)){
                //exit("call session");
