...
function xmldb_facetoface_upgrade($oldversion=0) {
    ...
    // US #5635 : Task 5842 add field to track the creater of the sessions.
    if ($oldversion < 2022020700) {
        
        $table = new xmldb_table('facetoface_sessions');

        $field = new xmldb_field('createdby', XMLDB_TYPE_INTEGER, '10', XMLDB_UNSIGNED, null, null, 0);

        if (!$dbman->field_exists($table, $field)) {
            $dbman->add_field($table, $field);
        }
        upgrade_mod_savepoint(true, 2022020700, 'facetoface');
    }
    ...
    if ($oldversion < 2022062300) {
        ...
        $field1 = new xmldb_field('clearwaitlistsubject', XMLDB_TYPE_TEXT, 'small', null, null, null, null);
        if (!$dbman->field_exists($table, $field1)) {
            $dbman->add_field($table, $field1);
        }

        $field2 = new xmldb_field('clearwaitlistmessage', XMLDB_TYPE_TEXT, 'medium', null, null, null, null);
        if (!$dbman->field_exists($table, $field2)) {
            $dbman->add_field($table, $field2);
        }
        upgrade_mod_savepoint(true, 2022062300, 'facetoface');
    }
    ...
    if ($oldversion < 2022071900) {
        ...
        // prerequisite msg for reserved users field
        $field = new xmldb_field('prereqconfirmsub');
        $field->set_attributes(XMLDB_TYPE_TEXT, 'medium', null, null, null, null,'emailmanagerlearnerprerequisite');
        ...
        $field1 = new xmldb_field('prerequisiterequired');
        $field1->set_attributes(XMLDB_TYPE_TEXT, 'medium', null, null, null, null,'prereqconfirmsub');
        ...
        $field2 = new xmldb_field('prereqconfrmflag');
        $field2->set_attributes(XMLDB_TYPE_INTEGER, 1, XMLDB_UNSIGNED, null, null, null,'prerequisiterequired');

        if (!$dbman->field_exists($table, $field2)) {
            $dbman->add_field($table, $field2);
        }

        // prerequisite msg for waitlisted users field
        $field3 = new xmldb_field('prewaitconfrmsub');
        $field3->set_attributes(XMLDB_TYPE_TEXT, 'medium', null, null, null, null,'prereqconfrmflag');
        ...
        $field4 = new xmldb_field('prerequisitewaitlisted');
        $field4->set_attributes(XMLDB_TYPE_TEXT, 'medium', null, null, null, null,'prewaitconfrmsub');
        ...
        $field5 = new xmldb_field('waitlistedconfrmflag');
        $field5->set_attributes(XMLDB_TYPE_INTEGER, 1, XMLDB_UNSIGNED, null, null, null,'prerequisitewaitlisted');
        ...
        // prerequisite reserved/waitlisted user list msg for manager field 3 weeks
        $field6 = new xmldb_field('mgrpreconfsub');
        $field6->set_attributes(XMLDB_TYPE_TEXT, 'medium', null, null, null, null,'waitlistedconfrmflag');
        ...
        $field7 = new xmldb_field('managerprerequisitemessage');
        $field7->set_attributes(XMLDB_TYPE_TEXT, 'medium', null, null, null, null,'mgrpreconfsub');
        ...
        $field8 = new xmldb_field('mgrprereqconfrmflag');
        $field8->set_attributes(XMLDB_TYPE_INTEGER, 1, XMLDB_UNSIGNED, null, null, null,'managerprerequisitemessage');

        if (!$dbman->field_exists($table, $field8)) {
            $dbman->add_field($table, $field8);
        }

        // Warning msg for users field 2 weeks
        $field9 = new xmldb_field('warningmessagesubject');
        $field9->set_attributes(XMLDB_TYPE_TEXT, 'medium', null, null, null, null,'mgrprereqconfrmflag');
        ...
        $field10 = new xmldb_field('warningmessage');
        $field10->set_attributes(XMLDB_TYPE_TEXT, 'medium', null, null, null, null,'warningmessagesubject');
        ...
        $field11 = new xmldb_field('warningmsgconfrmflag');
        $field11->set_attributes(XMLDB_TYPE_INTEGER, 1, XMLDB_UNSIGNED, null, null, null,'warningmessage');

        if (!$dbman->field_exists($table, $field11)) {
            $dbman->add_field($table, $field11);
        }

        // prerequisite reserved/waitlisted user list msg for manager 2 weeks field 
        $field12 = new xmldb_field('managerwarningmessagesubject');
        $field12->set_attributes(XMLDB_TYPE_TEXT, 'medium', null, null, null, null,'warningmsgconfrmflag');
        ...
        $field13 = new xmldb_field('managerwarningmessage');
        $field13->set_attributes(XMLDB_TYPE_TEXT, 'medium', null, null, null, null,'managerwarningmessagesubject');
        ...
        $field14 = new xmldb_field('mgrwarningmsgconfrmflag');
        $field14->set_attributes(XMLDB_TYPE_INTEGER, 1, XMLDB_UNSIGNED, null, null, null,'managerwarningmessage');

        if (!$dbman->field_exists($table, $field14)) {
            $dbman->add_field($table, $field14);
        }

        // Warning msg for users less than 2 weeks field 
        $field15 = new xmldb_field('lessthantwoweekssubject');
        $field15->set_attributes(XMLDB_TYPE_TEXT, 'medium', null, null, null, null,'mgrwarningmsgconfrmflag');
        ...
        $field16 = new xmldb_field('msglessthantwoweeks');
        $field16->set_attributes(XMLDB_TYPE_TEXT, 'medium', null, null, null, null,'lessthantwoweekssubject');
        ...
        $field17 = new xmldb_field('lessthantwoweeksconfrmflag');
        $field17->set_attributes(XMLDB_TYPE_INTEGER, 1, XMLDB_UNSIGNED, null, null, null,'msglessthantwoweeks');

        if (!$dbman->field_exists($table, $field17)) {
            $dbman->add_field($table, $field17);
        }

        // Warning msg for manager less than 2 weeks field 
        $field18 = new xmldb_field('mgrlessthantwoweekssubject');
        $field18->set_attributes(XMLDB_TYPE_TEXT, 'medium', null, null, null, null,'lessthantwoweeksconfrmflag');
        ...
        $field19 = new xmldb_field('mgrmsglessthantwoweeks');
        $field19->set_attributes(XMLDB_TYPE_TEXT, 'medium', null, null, null, null,'mgrlessthantwoweekssubject');
        ...
        $field20 = new xmldb_field('mgrlessthantwoweeksconfrmflag');
        $field20->set_attributes(XMLDB_TYPE_INTEGER, 1, XMLDB_UNSIGNED, null, null, null,'mgrmsglessthantwoweeks');

        if (!$dbman->field_exists($table, $field20)) {
            $dbman->add_field($table, $field20);
        }

        upgrade_mod_savepoint(true, 2022071900, 'facetoface');
    ...
    //US 8419 starts
    // Custome table classroom_autoenrolled_delete
    if ($oldversion < 2017053000) {
        $table = new xmldb_table('classroom_autoenrolled_delete');
        $table->add_field('id', XMLDB_TYPE_INTEGER, '10', XMLDB_UNSIGNED, XMLDB_NOTNULL, XMLDB_SEQUENCE, null);
        $table->add_field('user_id', XMLDB_TYPE_CHAR, '255', null, XMLDB_NOTNULL, null, null);
        $table->add_field('course_id', XMLDB_TYPE_INTEGER, '50', XMLDB_UNSIGNED, XMLDB_NOTNULL, null, null);
        $table->add_field('page', XMLDB_TYPE_CHAR, '255', null, null, null, null);
        $table->add_field('cron_status', XMLDB_TYPE_INTEGER, '50', XMLDB_UNSIGNED, XMLDB_NOTNULL, 0, null);
        $table->add_field('impacted_flag', XMLDB_TYPE_INTEGER, '10', XMLDB_UNSIGNED, XMLDB_NOTNULL, 0, null);
        $table->add_field('created_date', XMLDB_TYPE_INTEGER, '10', XMLDB_UNSIGNED, XMLDB_NOTNULL, XMLDB_TYPE_TIMESTAMP, null);
        $table->add_field('updated_date', XMLDB_TYPE_INTEGER, '10', XMLDB_UNSIGNED, null, null, null);
        $table->add_key('primary', XMLDB_KEY_PRIMARY, array('id'));
    ...
    // Custom table get_multiple_session_user_enrolled
    if ($oldversion < 2017053000) {
        $table = new xmldb_table('get_multiple_session_user_enrolled');
        ...
        $table->add_field('facetofaceid', XMLDB_TYPE_INTEGER, '11', XMLDB_UNSIGNED, XMLDB_NOTNULL, null, null);
        $table->add_field('sessionid', XMLDB_TYPE_INTEGER, '11', XMLDB_UNSIGNED, XMLDB_NOTNULL, null, null);
        $table->add_field('statuscode', XMLDB_TYPE_INTEGER, '11', XMLDB_UNSIGNED, XMLDB_NOTNULL, null, null);
        $table->add_key('primary', XMLDB_KEY_PRIMARY, array('id'));
    ...
    // Custome fields of facetoface
    if ($oldversion < 2017053000) {
        $table = new xmldb_table('facetoface');
        $table->add_field('attendedautomatedemailmsg', XMLDB_TYPE_CHAR, '255', null, null, null, null);
        $table->add_field('attendedautomatedemailsub', XMLDB_TYPE_CHAR, '255', null, null, null, null);
        $table->add_field('resconfirmrostersubject', XMLDB_TYPE_CHAR, '255', null, null, null, null);
        $table->add_field('resconfirmrostermsg', XMLDB_TYPE_CHAR, '255', null, null, null, null);
        $table->add_field('meta_descriptions', XMLDB_TYPE_CHAR, '255', null, null, null, null);
        $table->add_field('meta_keywords', XMLDB_TYPE_CHAR, '255', null, null, null, null);
        $table->add_field('confirmationloctrnsubject', XMLDB_TYPE_CHAR, '255', null, null, null, null);
        $table->add_field('confirmationloctrnmgr', XMLDB_TYPE_CHAR, '255', null, null, null, null);
        $table->add_field('confirmationloctrnmsg', XMLDB_TYPE_CHAR, '255', null, null, null, null);
        $table->add_field('rescancelbyadminsubject', XMLDB_TYPE_CHAR, '255', null, null, null, null);
        $table->add_field('rescancelbyadminmsg', XMLDB_TYPE_CHAR, '255', null, null, null, null);
        $table->add_field('confirmfromwaitlistedsubject', XMLDB_TYPE_CHAR, '255', null, XMLDB_NOTNULL, null, null);
        $table->add_field('confirmfromwaitlistedmsg', XMLDB_TYPE_CHAR, '255', null, XMLDB_NOTNULL, null, null);
        $table->add_field('notattendedautomatedemailsub', XMLDB_TYPE_CHAR, '255', null, null, null, null);
        $table->add_field('notattendedautomatedemailmsg', XMLDB_TYPE_CHAR, '255', null, null, null, null);
        $table->add_field('prerequisitemessage', XMLDB_TYPE_CHAR, '255', null, null, null, null);
        $table->add_field('prerequisitesubject', XMLDB_TYPE_CHAR, '255', null, null, null, null);
        $table->add_field('prerequisiteinstrmngr', XMLDB_TYPE_CHAR, '255', null, null, null, null);
        $table->add_field('emailmanagerlearnerprerequisite', XMLDB_TYPE_INTEGER, '11', null, XMLDB_NOTNULL, 1, null);
    ...
    if ($oldversion < 2017053000) {
        $table = new xmldb_table('facetoface_cancel_session_student_email_log');
        $table->add_field('id', XMLDB_TYPE_INTEGER, '11', XMLDB_UNSIGNED, XMLDB_NOTNULL, XMLDB_SEQUENCE, null);
        $table->add_field('session_id', XMLDB_TYPE_INTEGER, '11', null, null, null, null);
    ...
    if ($oldversion < 2022071901) {
        ...
        // Define field isattended to be added to facetoface_signups_status.
        $table = new xmldb_table('facetoface_signups_status');
        $field = new xmldb_field('isattended', XMLDB_TYPE_INTEGER, '1', null, null, null, null, 'superceded');

        // Conditionally launch add field isattended.
        if (!$dbman->field_exists($table, $field)) {
            $dbman->add_field($table, $field);
        }

        // Facetoface savepoint reached.
        upgrade_mod_savepoint(true, 2022071901, 'facetoface');
    }
