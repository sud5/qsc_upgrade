 ...
 */
$string['waithead'] = 'WAIT!';
$string['waitdesc'] = 'You are currently registered to attend an in-class Q-SYS Level 1 course. As such, you are not required to pass online assessments to in order to become Q-SYS Level 1 certified. <br><br>
If you would still like to take this assessment, click below to continue <br><br>
If you would prefer to take our online course, navigate to your in-class enrollment and cancel your reservation. <br><br>
Good luck!';
$string['gradinginprogress'] = 'Grading in Progress';	
$string['inside_qsc'] = 'Inside QSC';
$string['outside_qsc'] = 'Outside QSC';
$string['local_classess'] = 'Local Classess';
$string['no_reason'] = 'Reason not found';
$string['managersemail_help'] = 'Please add the comma separated values for another email address for eg: lms@xyz.com,abc@xyz.com';
$string['custom_managersemail_help'] = 'Please add the comma separated values for another email address for eg: lms@xyz.com,abc@xyz.com';
$string['time_length'] = 'Length';
...
$string['alreadyonline'] = 'Already certified';
$string['alreadysubmit'] = 'Already submit classroom exam';
...
$string['localtrainingmessage'] = 'Local Training Enquiry message';
$string['rescancelbyadminmessage'] = 'Session Cancellation by Admin';

//Classroom feature start
$string['confirmfromwaitlistedmessage'] = 'Confirmation Message - Auto enrolled from the Waitlist';
...
$string['continuetologin'] = 'Please log-in or create a profile before signing up for this session.';
$string['copy'] = 'Copy';
$string['cost'] = 'Cost';
$string['cancelbooking'] = 'Cancel booking';
...
$string['cancellationconfirm'] = 'Are you sure that you want to cancel your booking?';
...
$string['logos'] = 'Session Logo 180x100';
...
$string['email:instrloctrnmngr'] = 'Notice for local sales rep.';
...
$string['guestsno'] = 'QSC curriculum is open to all, but you will need to register with the website first.';
...
$string['noupcoming'] = '<p><i>No upcoming Classroom Sessions</i></p>';
$string['noupcomingInRegion'] = '<p><i>There are currently no public classrooms scheduled in this region</i></p>';
...
$string['placeholder:diet'] = '[Dietary]';
$string['placeholder:rtitle'] = '[Refer]';
$string['placeholder:TrainingTitle'] = '[TrainingTitle]';
...
$string['placeholder:Company'] = '[Company]';
$string['placeholder:EmailAddress'] = '[email]';
$string['placeholder:PhoneNumber'] = '[PhoneNumber]';

//63 est start
$string['placeholder:LevelOneCertified'] = '[LevelOneCertified]';
//63 est end

$string['placeholder:Address'] = '[Address]';
$string['placeholder:City'] = '[City]';
$string['placeholder:State'] = '[State]';
$string['placeholder:Zipcode'] = '[Zipcode]';
...
$string['permissioncode_notfound_error'] = 'Please enter correct Permission code';
$string['zipcode_notfound_error'] = 'Please enter correct Zip code';
$string['zipcode'] = 'Zip code';
$string['terms_label'] = 'You must complete Q-SYS Level One no later than two weeks before this event. If you fail to do so, your reservation may be canceled.
Do you understand?';
$string['terms_error'] = 'Choosen option for registration has not been met.';
$string['permissioncode_notfound_error'] = 'This event requires a permission code to complete registration.';
$string['permissioncode_label'] = 'Please enter your permission code.';
...
$string['setting:defaultrescancelbyadminsubjectdefault'] = 'Cancellation of QSC Training Session';

$string['setting:defaultrescancelbyadminmessagedefault'] = 'Hi [firstname],
The training session you had previously registered for has been cancelled.

[session:title]
[Date], [Time]
[session:Street], [session:Location]

We apologize for the inconvenience. Feel free to register for an alternate session at www.training.qsc.com. If you need assistance or have any questions please contact our training team at qsc.training@qsc.com. We hope you’ll be able to attend a future classroom training session with us.

Cheers,
The QSC Training & Education Team
www.training.qsc.com 
';
...
$string['signupforsession'] = 'Sign-up for an available upcoming classroom session';
...
$string['submit-R'] = 'Submit Registration';
...
$string['upcomingsessions'] = 'Upcoming Classroom Sessions';
$string['upcomingsessionslist'] = 'List of all upcoming classroom sessions for this Face-to-Face activity';
...
$string['confirmationloctrnmsg'] = '# Notice for local sales rep.';
$string['confirmationinstrmngr'] = '# Notice for admin';
...
$string['localtrainingmessage_help'] = 'This message is sent out whenever users sign up for a local class Q-SYS Level 1 session.';
$string['rescancelbyadminmessage_help'] = 'This message is sent out to all registrants whenever admin/manager cancelled selected session of the class.';
//Classroom feature start
$string['confirmfromwaitlistedmessage_help'] = 'Student will automatically be moved from the wait list to the class roster. A confirmation e-mail will be sent to student when this occurs.';
//Classroom feature end
...
$string['details_help'] = 'Logos are tracked per session basis. The logo thumbnail image will be displayed on the user signup page.
By default, it also appears in the confirmation, reminder, waitlist and cancellation email messages.';
...
//FORM input field frontend
$string['who_refer_you_desc'] = 'Please explain restriction if applicable.';
$string['diet_restriction'] = 'A continental breakfast and light lunch is provided. Do you have any special dietary restriction? (these meals are only provided for the physical In-Classroom Sessions)';
$string['terms'] = 'Q-SYS Level One Training attendees are required to bring a laptop with the latest version of Q-SYS Designer Software installed prior to training. Youmust also ensure that your laptop has a physical Ethernet port, and that you bring a mouse for your laptop. Do you agree to this requirement?';
$string['terms_fundamental'] = 'Q-SYS Training: Control & UCI Fundamentals attendees are required to bring a laptop with the latest version of Q-SYS Designer Software installed prior to training. Youmust also ensure that your laptop has a physical Ethernet port, and that you bring a mouse for your laptop. Do you agree to this requirement?';
$string['who_refer_you_title'] = 'Who referred you to this event (Name and Company)';

//SIGNUP PAGE
$string['signupSubHeading'] = 'Your Selection:';
//ATTENDEES PAGE
$string['company'] = 'Company';
$string['email'] = 'Email';
$string['address'] = 'Address';
$string['levelheading'] = 'Level 1';
$string['dietheading'] = 'Diet Restriction';

//lib
$string['thankyou_head'] = "Your registration request has been received!";
$string['thankyou_message'] = 'Someone will be in touch with you shortly with more information about your selected training session. Feel free to contact <a href="mailto:qsc.training@qsc.com" >qsc.training@qsc.com</a> if you have any further questions or need assistance with your registration.';

$string['terms_2'] = 'Q-SYS Level Two Training attendees are required to bring a laptop with the latest version of Q-SYS Designer Software installed prior to training. Youmust also ensure that your laptop has a physical Ethernet port, and that you bring a mouse for your laptop. Do you agree to this requirement?';
$string['terms_touchmix'] = 'Touchmix Certified Operator Training attendees are required to bring headphones to their training.  Do you agree to this requirement?';
$string['terms_touchmix_smartphone'] = 'Touchmix Certified Operator Training attendees are required to bring a tablet or smartphone device with the latest Touchmix app downloaded onto it. Do you agree to this requirement?';
//PP1 start
$string['upcomingsessions'] = 'Upcoming and Ongoing Classroom Sessions';
//PP1 end

//Classroom Signup Code start
$string['levelonestatus'] = 'Level One Certified';
//Classroom Signup Code end

// Addition Certification Columns Start
$string['leveltwostatus'] = 'Level Two Certified';
// Addition Certification Columns End

//Classroom Feature start
$string['thankyou_head'] = 'Your registration is complete!';
//trp start
$string['thankyou_trp_head'] = "Your request has been received!";
//trp end
$string['wphead'] = 'This session is currently full.';
$string['wpdesc'] = 'After completing your registration, you will be added to this session’s waitlist. Should a seat open up, you will automatically be moved from the waitlist to the class roster and a confirmation email will be sent.  Priority is given based on the date of registration.';
$string['wprlink'] = 'Register for waitlist';
$string['wpclink'] = 'Cancel';
//Classroom Feature end

/* ZIPCODE FILE MODIFICATION - START BY PAWAN */
$string['country'] = 'Country';
/* ZIPCODE FILE MODIFICATION - END BY PAWAN */

/* SUBMIT A LOCAL TRAINING REQUEST BY PAWAN - START HERE */
$string['localtrainingrequest'] = 'Submit a Local Training Request';
$string['unlimited'] = 'Unlimited';
$string['comment'] = 'If you would like, please include a message to the distributor in regards to your interest in a class.';

$string['placeholder:country_request'] = '[Country_request]';
$string['placeholder:zipcode_request'] = '[Zipcode_request]';
$string['placeholder:comment_request'] = '[Comment_request]';

/* SUBMIT A LOCAL TRAINING REQUEST BY PAWAN - END HERE */

// TRP start

$string['thankyou_message_request'] = 'Someone will be in touch with you shortly with more information about your Q-SYS LEVEL training request. Feel free to contact <a href="mailto:qsc.training@qsc.com" >qsc.training@qsc.com</a> if you have any further questions or need assistance with your registration.';	

// TRP end
$string['showbyregion'] = 'Show by Region';

// ----- customization_Naveen_Start --------//
$string['confirm_roster'] = 'Confirm Roster';
// ----- customization_Naveen_End --------//
// ----- customization_Sameer_Start --------//
$string['resconfirmrostermessage'] = 'Manager Roll Call Message';
$string['attendedautomatedemail'] = '(24hrs) After Attendance Message';
$string['setting:defaultattendedautomatedemailsub'] = 'Default subject line for automated emails.';
$string['setting:defaultattendedautomatedemailsub_caption'] = '24 hours after the session Automated email to users subject';
$string['setting:defaultattendedautomatedemailsubdefault'] = '24 hours after the session system sent an email to the attended users';
$string['setting:defaultattendedautomatedemailmsg'] = 'Default automated message sent to students.';
$string['setting:defaultattendedautomatedemailmsg_caption'] = 'Automated message (students)';
$string['setting:defaultattendedautomatedemailmsgdefault'] = 'Please add message';

//Task 2061
$string['notattendedautomatedemail'] = 'Session Cancellation during Confirmed Roster';
$string['setting:defaultnotattendedautomatedemailsub'] = 'Session Cancelled';
$string['setting:defaultnotattendedautomatedemailsub_caption'] = 'a user is automatically unenrolled from a session';
$string['setting:defaultnotattendedautomatedemailsubdefault'] = 'Session Cancelled';
$string['setting:defaultnotattendedautomatedemailmsg'] = 'Default automated message sent to students.';
$string['setting:defaultnotattendedautomatedemailmsg_caption'] = 'Automated message (students)';
$string['setting:defaultnotattendedautomatedemailmsgdefault'] = 'Please add message';
// ----- customization_Sameer_End --------//
// ----- customization_Sameer_End --------//
// - - - - - - - - Start-Feature Request: In-Classroom "Reserve" button -Nav - - - - -- //
$string['reserve_in_waitlist'] = 'Join Waitlist';
// - - - - - - - - End-Feature Request: In-Classroom "Reserve" button -Nav - - - - -- //

////Task 2369 start
$string['seats_left'] = 'Seats Left';
$string['training_request_heading'] = 'Submit a Local Training Request';
$string['training_request_sub_heading'] = "Don't see a training session that's right for you?";
$string['training_request_desc1'] = 'Submit a Training Request form to notify your regional Q-SYS distributor that you would be interested in attending a local class.';
$string['training_request_desc2'] = 'Submit a Training Request form to notify the QSC Training team that you would be interested in attending a local class.';
////Task 2369 end

//US 3072 start
$string['countryrestriction'] = 'Country Restriction';
//US 3072 end

//Added by Priya for US#6050
$string['emailuser'] = 'Send notice to user';
$string['prereqconfrmflag'] = '# Send notice to user';
$string['waitlistedconfrmflag'] = '# Send notice to user';
$string['mgrprereqconfrmflag'] = '# Send notice to manager';
$string['warningmsgconfrmflag'] = '# Send notice to user';
$string['mgrwarningmsgconfrmflag'] = '# Send notice to manager';
$string['lessthantwoweeksconfrmflag'] = '# Send notice to user';
$string['mgrlessthantwoweeksconfrmflag'] = '# Send notice to manager';
$string['prerequisiterequired'] = 'Prerequisite Required Message for Reserved Users 3 Weeks';
$string['prerequisitewaitlisted'] = 'Prerequisite Required Message for Wait-listed Users 3 Weeks';
$string['managerprerequisitemessage'] = 'Manager Pre-requisite Message For Reserved and Waitlisted Users 3 Weeks';
$string['warningmessage'] = 'Warning Message for Reserved and Waitlisted Users 2 Weeks';
$string['managerwarningmessage'] = 'Manager Pre-requisite Message For Reserved and Waitlisted Users 2 Weeks';
$string['msglessthantwoweeks'] = 'Warning Message for Reserved and Waitlisted Users Less Than 2 Weeks';
$string['mgrmsglessthantwoweeks'] = 'Manager Pre-requisite Message For Reserved and Waitlisted Users Less Than 2 Weeks';
//END of Added by Priya for US#6050
//US 6050 start
$string['prerequisite'] = 'Prerequisite';
$string['prerequisitemessage'] = 'Prerequisite message';
$string['sentprerequisitemanager'] = 'Sent prerequisite email to user manager';
$string['sentprerequisiteuser'] = 'Sent prerequisite email to user';
$string['setting:defaultresconfirmrostersubjectdefault'] = 'Confirm roster subject';
$string['setting:defaultresconfirmrostersubjectdefault'] = 'Confirm roster message';
$string['setting:defaultprerequisitesubject'] = 'Default subject line for prerequisite emails.';
$string['setting:defaultprerequisitesubject_caption'] = 'Prerequisite subject';
$string['setting:defaultprerequisitesubjectdefault'] = 'Course booking prerequisite: [facetofacename], [starttime]-[finishtime], [sessiondate]';
$string['setting:defaultprerequisitemessage'] = 'Default prerequisite message sent to users.';
$string['setting:defaultprerequisitemessage_caption'] = 'Prerequisite message';
$string['setting:defaultprerequisitemessagedefault'] = 'This is a prerequisite that you are booked on the following course:';
$string['prerequisiteinstrmngr'] = '# Notice for Manager';
$string['prerequisiteinstrmngr_help'] = 'When **Send notice to manager** is checked, the text in the **Notice for Manager** field is sent to a learner\'s manager advising that they have signed up for a Face-to-Face session.';

$string['prerequisitemessage_help'] = 'This message is sent out a few days before a session\'s start date.';
$string['emailmanagerprerequisite'] = '# Send notice to manager and student';
$string['emailmanagerprerequisite_help'] = 'When "Send notice to manager and student" is checked, a prerequisite message will be sent to the learner and their manager a few days (3 weeks, 2 weeks and less than 2 weeks) before the start date of the Face-to-Face session.';
//US 6050 end

// US 6665 starts
$string['clearwaitlist'] = 'Clear Wait-List';
$string['clearwaitlistconfirm'] = 'Are you completely sure you want to clear this waitlist and all sign-ups for this session?';
$string['clearwaitlistusers'] = 'Clear users from the waitlist of session {$a}';
$string['subject'] = 'Waitlist Canceled';
$string['msgbody'] = 'If you are receiving this then the manager and/or instructor has decided to remove the waitlist for the following session';
$string['error:couldnotclearwaitlist'] = 'Could not clear waitlist of the session';
$string['clearwaitlistadminmessage'] = 'Clear Waitlist by Admin';
$string['clearwaitlistadminmessage_help'] = 'This message is sent out to all signups whenever admin/manager clear the waitlist of the selected session of the class.';
$string['setting:defaultclearwaitlistsubject'] = '[session:title] Waitlist Canceled';

$string['setting:defaultclearwaitlistmessage'] = 'Hi [firstname], 
    
If you are receiving this then the manager and/or instructor has decided to remove the waitlist for the following session:

[session:title]
[sessiondate], [Time] 
[session:Location], [session:Street]

This is most likely due to the current roster being confirmed, meaning there will not be any available seats for the waitlist to fill. Please feel free to sign up for another session or another waitlist. If you need further assistance or have any questions feel free to contact our training team at qsc.training@qsc.com. We hope you’ll be able to attend a future classroom training session with us!

Cheers,
The QSC Training & Education Team
training.qsc.com 
';
$string['placeholder:sessiontitle'] = '[session:title]';
$string['placeholder:firstname'] = '[firstname]';
$string['placeholder:sessiondate'] = '[sessiondate]';
$string['placeholder:time'] = '[Time]';
$string['placeholder:location'] = '[session:Location]';
$string['placeholder:street'] = '[session:Street]';
$string['error:nowaitlistuser'] = 'No wait-list user exist in this session';
//US 6665 ends
