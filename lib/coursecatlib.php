...
class coursecat implements renderable, cacheable_object, IteratorAggregate {
    ...
    protected static $coursecatfields = array(
        ...
        'meta_keywords' => null, // Not cached.
        'meta_descriptions' => null, // Not cached.
    ...
    /** @var string */
    protected $meta_descriptions = false;

    /** @var string */
    protected $meta_keywords = false;
    ...
    public static function create($data, $editoroptions = null) {
        ...
        if (isset($data->meta_descriptions)) {
            $newcategory->meta_descriptions = $data->meta_descriptions;
        }
        //seo settings end
