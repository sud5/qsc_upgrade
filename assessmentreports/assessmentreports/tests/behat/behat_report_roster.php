 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class behat_report_assessmentreports extends behat_base {
    /**
     * Sets the 'fields' config value as admin
     *
     * @Given /^I set report_assessmentreports\/fields to:$/
     * @param PyStringNode $value A triple-quote delimited text block to be set as the value of the setting
     */
    public function i_set_report_assessmentreports_fields_to(PyStringNode $value) {
        set_config('fields', $value->getRaw(), 'report_assessmentreports');
    }
