...
class mergeuserform extends moodleform {
    ...
    public function definition() {
        ...
        $idstype = array(
            'username' => get_string('email'),
            'id'       => 'UserUniqueIdNumber',
        );
	...
	$searchfields = array(
       ...
       // Add elements
        $searchuser = array();
        $searchuser[] = $mform->createElement('text', 'searcharg',"", 'size="35"');
        ...
        $olduser = array();
        $olduser[] = $mform->createElement('text', 'olduserid', "", 'size="35"');
        ...
        $newuser = array();
        $newuser[] = $mform->createElement('text', 'newuserid', "", 'size="35"');
